...
export default function ShoppingListItem({ listId }: { listId: string }) {
  ...
  const userNicknames = useShoppingListCollaboratorNicknames(listId);
              ...
              {userNicknames.length > 1 && (
                <View style={styles.nicknameContainer}>
                  {userNicknames.length === 4
                    ...
                    userNicknames.map((nickname: string | undefined, index: number) => (
                      <NicknameCircle
                        key={nickname || index}
                        nickname={nickname || ""}
                        color={color || "#000000"}
                    ...
                    : userNicknames.length > 4
                      ...
                      userNicknames
                        .slice(0, 4)
                        .map((nickname: string | undefined, index: number) => (
                          <NicknameCircle
                            key={nickname || index}
                            nickname={nickname || ""}
                            color={color || "#000000"}
