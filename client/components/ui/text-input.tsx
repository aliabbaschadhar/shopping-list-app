...
import { appleRed, zincColors } from "@/constants/theme";
import { ThemedText } from "../themed-text";

type InputVariant = "default" | "filled" | "outlined" | "ghost";
type InputSize = "sm" | "md" | "lg";

// Omit is a typescript utility type that constructs a type by picking all properties from RNTextInputProps and then removing keys specified in the second parameter
